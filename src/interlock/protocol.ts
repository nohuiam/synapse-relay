 ...
 */
function decodeBinaryMessage(buffer: Buffer): InterLockMessage | null {
  try {
 ...
 */
function mapTypeStringToNumber(typeStr: string): number {
 ...
 */
function decodeTextMessage(buffer: Buffer): InterLockMessage | null {
  try {
 ...
 */
export function decodeMessage(buffer: Buffer): InterLockMessage | null {
